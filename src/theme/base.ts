...
declare module "@mui/material/styles" {
  interface Theme {
    ...
    codeArticle: {
      codeColor: React.CSSProperties["color"];
      preBackground: React.CSSProperties["color"];
      articleCodeHeaderBcg: React.CSSProperties["color"];
      articleCodeHeaderDotBcg: React.CSSProperties["color"];
    };
    header: {
      height: string;
      background: React.CSSProperties["color"];
